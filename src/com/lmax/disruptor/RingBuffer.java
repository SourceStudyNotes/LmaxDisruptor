 ...
 * 内存对齐：
 * </p> 
 * http://ju.outofmemory.cn/entry/106560
 * </p>
 * http://darkc.at/about-data-structure-alignment/
 * 
 * @author "wangbin01"
 */
...
abstract class RingBufferFields<E> extends RingBufferPad {
     ...
     * </p>
     * 2.java8\openjdk\jdk\src\share\classes\sun\misc\Unsage.java
     * </p>
     */
    ...
    protected final int bufferSize;//四个字节对齐
    private final Object[] entries; //四个字节对齐
    protected final Sequencer sequencer;//四个字节对齐
...
public final class RingBuffer<E> extends RingBufferFields<E> implements Cursored, EventSequencer<E>, EventSink<E> {
     ...
     * recieved will depend on the type of {@link Sequencer} that is being used.
     * 
     * @see MultiProducerSequencer
     * @see SingleProducerSequencer
     */
     ...
     *      Object)
     *      com.lmax.disruptor.EventSink#publishEvent(com.lmax.disruptor.
     *      EventTranslatorOneArg, A)
     */
    @Override
     ...
     *      Object)
     *      com.lmax.disruptor.EventSink#tryPublishEvent(com.lmax.disruptor.
     *      EventTranslatorOneArg, A)
     */
    @Override
     ...
     *      Object[])
     *      com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.
     *      EventTranslatorOneArg, A[])
     */
    @Override
     ...
     *      int, int, Object[])
     *      com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.
     *      EventTranslatorOneArg, int, int, A[])
     */
    @Override
     ...
     *      Object[])
     *      com.lmax.disruptor.EventSink#tryPublishEvents(com.lmax.disruptor.
     *      EventTranslatorOneArg, A[])
     */
    @Override
     ...
     *      com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.
     *      EventTranslatorTwoArg, int, int, A[], B[])
     */
    @Override
     ...
     *      com.lmax.disruptor.EventSink#publishEvents(com.lmax.disruptor.
     *      EventTranslatorThreeArg, int, int, A[], B[], C[])
     */
    @Override
    ...
    private <A> void batchOverRuns(final A[] arg0, final int batchStartsAt, final int batchSize) {
        if (batchStartsAt + batchSize > arg0.length) {
            throw new IllegalArgumentException("A batchSize of: " + batchSize + " with batchStatsAt of: "
                    + batchStartsAt + " will overrun the available number of arguments: "
